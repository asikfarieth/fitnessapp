  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      <ion-header collapse="condense">
        <ion-toolbar>          <ion-title size="large">Weight Tracker</ion-title>
        </ion-toolbar>
      </ion-header>
      ...
      <main>
        ...
        <div v-if="weights && weights.length > 0">
          ...
          <div class="weight-history">
            ...
            <ul>
              <li v-for="weight in weights" v-bind:key="weight.weight">
...
const currentWeight = computed(() => {
  return (
    weights.value.slice().sort((a, b) => b.date - a.date)[0] || { weight: 0 }
  );
});
